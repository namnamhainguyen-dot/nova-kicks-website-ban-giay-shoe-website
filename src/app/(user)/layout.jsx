...
export default async function Layout({ children }) {
  ...
  return (
    <html lang="vi" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning className="d-flex flex-column min-vh-100">
        <Toaster
                ...
                <ul className="nk-categories-list">
                  <li>
                    <Link href="/products">
                      <i
                        className="fas fa-th"
                        style={{ marginRight: "6px", fontSize: "0.5rem" }}
                      ></i>
                      Tất cả
                    </Link>
                  </li>
                ...
                <ul className="nk-footer-links">
                  ...
                  >
                    <i
                      ...
                      style={{ color: "var(--accent)", width: "16px" }}
                    ></i>
        ...
        {/* Load Bootstrap Script qua Next.js Script Component */}
        <Script
          src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
          strategy="lazyOnload"
        />

        {/* Script xử lý scroll an toàn */}
        <Script id="scroll-effect" strategy="afterInteractive">
          {`
