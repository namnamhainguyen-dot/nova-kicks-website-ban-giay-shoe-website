      ...
      <div className="row justify-content-center">
        <div className="col-lg-9">
          ...
          <div className="d-flex flex-wrap align-items-center gap-3 text-muted small mb-4 border-bottom pb-3">
            ...
            <span>📅 Ngày tạo: {new Date(article.createdAt || Date.now()).toLocaleDateString("vi-VN")}</span>
          ...
          {/* Nội dung chi tiết từ CKEditor */}
          <div
            className="article-body lh-base mb-5"
            dangerouslySetInnerHTML={{ __html: article.content }}
          />

          {/* Khu vực hiển thị danh sách bình luận (nếu có) */}
            ...
            {(!article.comments || article.comments.length === 0) ? (
              ...
              <div className="d-flex flex-column gap-3">
                {article.comments.map((cmt) => (
                  <div key={cmt._id} className="card p-3 border-0 shadow-sm">
